...
class Comedor:
    ...
    def _calcular_capacidad_maxima(self) -> int:
        ...
        # Asumir que cada 60cm de largo permiten una silla
        capacidad_por_largo = int(self._mesa.largo // 60)
        # Máximo 12 sillas para evitar mesas demasiado grandes
        return min(capacidad_por_largo, 12)
