...
class TiendaMuebles:
    ...
    def total_comedores(self) -> int:
        """Retorna el total de comedores en inventario."""
        return len(self._comedores)
    
    @property
    def catalogo(self) -> CatalogoMuebles:
        """Retorna un objeto catálogo con todos los muebles."""
        todos_los_muebles = self._inventario + self._comedores
        return CatalogoMuebles(todos_los_muebles)
